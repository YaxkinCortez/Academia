...
<body id="default_theme" class="it_service">
            ...
            <div class="row">
                    ...
                    <div class="full">
                        <div class="topbar-left">
                            <ul class="list-inline">
                                <li> <?php echo $row3['num_control'] ?> </li>
                                <li> <?php echo $row3['nombre'] ?> </li>
                                <li> <?php echo $row3['apellidos'] ?> </li>
                            </ul>
                        </div>
                    </div>
                </div>
                <div class="col-md-4 right_section_header_top">
                    <div class="float-right">
                        <div class="make_appo"> <a class="btn white_btn" href="../modelos/salir.php">Cerrar sesion</a>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <!-- end header top -->
        ...
        <div class="header_bottom pegadiso">
            <div class="container">
                <div class="row">
                    <div class="col-lg-3 col-md-12 col-sm-12 col-xs-12">
                        <!-- logo start -->
                        <div class="logo"> <a href="dashboard.php"><img src="../images/logos/academica.png"
                                    alt="logo" /></a> </div>
                        <!-- logo end -->
                    </div>

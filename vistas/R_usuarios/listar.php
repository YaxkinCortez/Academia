...
<body id="default_theme" class="it_service">
        ...
        <table class="table table-hover table-dark">
            ...
            <?php
    $sql2="SELECT a.num_control, a.nombre, a.apellidos, a.telefono, a.correo, a.semestre, a.grupo, c.nombre_carrera 
    FROM alumnos a, carrera c 
    WHERE a.carrera     = c.id_carrera 
    ORDER BY nombre";
            ...
            <tr>
                ...
                <td>
                    <a class="btn btn-danger btn-sm"
                        href="../../modelos/eliminarUsuario.php?matricula=<?php echo $mostrar['num_control'];?>">Eliminar</a>
                </td>
            </tr>
            <?php
    }

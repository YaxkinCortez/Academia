...
if (!isset($_SESSION['inisiarSesion']) && $_SESSION['iniciarSesion'] == "ok") {
    header('loacation: ../vistas/perfil/updateperfil.php');
} else {
            ...
            <div class="row">
                ...
                <div class="col-lg-9 col-md-12 col-sm-12 col-xs-12">
                    ...
                    <div class="menu_side">
                        <div id="navbar_menu">
                            <ul class="first-ul">
                                <li><a class="active" href="../dashboard.php">Inicio</a></li>
                        ...
                        <div class="full">
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 contant_form">
                                ...
                                <div class="form_section">
                                    <form class="form_contant" action="../../modelos/actualizarContra.php"
                                        method="POST">
                                        <fieldset>
                                            <div class="row">

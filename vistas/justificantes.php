...
if (!isset($_SESSION['inisiarSesion']) && $_SESSION['iniciarSesion'] == "ok") {
    header('loacation: justificantes.php');
} else {
                    ...
                    <div class="full">
                        <div class="title-holder">
                            <div class="title-holder-cell text-left">
                                <h1 class="page-title">JUSTIFICANTE</h1>
                                <ol class="breadcrumb">
                                    <li><a href="dashboard.php">INICIO</a></li>
                                    <li class="active">JUSTIFICANTE</li>
                                </ol>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="full">
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 contant_form">
                                <h2 class="text_align_center">SOLICITAR JUSTIFICANTE</h2>
                                <div class="form_section">
                                    <form class="form_contant" action="../modelos/registrarPDF.php" method="POST">
                                        <fieldset>
                                            <div class="field col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                                <input class="field_custom" placeholder="Motivo" type="text"
                                                    name="motivo">
                                            </div>
                                            <div class="center">
                                                <button class="btn btn-warning">PEDIR</button>
                                            </div>
                                    </form>
                                </div>
                                </fieldset>

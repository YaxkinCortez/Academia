...
$sql2 = "INSERT INTO jefe_carrera(num_control, nombre, apellidos, contra, telefono, correo)
...
if (($_POST)) {
        if (empty($_POST['matricula']) || empty($_POST['nombre']) || empty($_POST['apellidos'])) {
            ...
            window.location.href="../vistas/R_usuarios/registroJefes.php";
          </script>';
        }else{
            if ($result >= 1) {
                echo '<script type="text/javascript">
                ...
                if ($conn->query($sql2) === true) {
                    echo '<script type="text/javascript">
                    alert("Registro exitoso de Jefe");
                    window.location.href="../vistas/R_usuarios/registroJefes.php";
                    </script>';
                } else {
